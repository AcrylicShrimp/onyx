...
namespace onyx::render {
	...
	{
		switch (eFormat) {
		case VkFormat::VK_FORMAT_R4G4_UNORM_PACK8: return 1;
		...
		case VkFormat::VK_FORMAT_A1R5G5B5_UNORM_PACK16: return 2;
		...
		case VkFormat::VK_FORMAT_R8_SRGB: return 1;
		...
		case VkFormat::VK_FORMAT_R8G8_SRGB: return 2;
		...
		case VkFormat::VK_FORMAT_B8G8R8_SRGB: return 3;
		...
		case VkFormat::VK_FORMAT_A2B10G10R10_SINT_PACK32: return 4;
		...
		case VkFormat::VK_FORMAT_R16_SFLOAT: return 2;
		...
		case VkFormat::VK_FORMAT_R16G16_SFLOAT: return 4;
		...
		case VkFormat::VK_FORMAT_R16G16B16_SFLOAT: return 6;
		...
		case VkFormat::VK_FORMAT_R16G16B16A16_SFLOAT: return 8;

		case VkFormat::VK_FORMAT_R32_UINT:
		case VkFormat::VK_FORMAT_R32_SINT:
		case VkFormat::VK_FORMAT_R32_SFLOAT: return 4;
		...
		case VkFormat::VK_FORMAT_R64_SFLOAT: return 8;

		case VkFormat::VK_FORMAT_R64G64_UINT:
		case VkFormat::VK_FORMAT_R64G64_SINT:
		case VkFormat::VK_FORMAT_R64G64_SFLOAT: return 16;

		case VkFormat::VK_FORMAT_R64G64B64_UINT:
		case VkFormat::VK_FORMAT_R64G64B64_SINT:
		case VkFormat::VK_FORMAT_R64G64B64_SFLOAT: return 24;

		case VkFormat::VK_FORMAT_R64G64B64A64_UINT:
		case VkFormat::VK_FORMAT_R64G64B64A64_SINT:
		case VkFormat::VK_FORMAT_R64G64B64A64_SFLOAT: return 32;

		case VkFormat::VK_FORMAT_B10G11R11_UFLOAT_PACK32:
		case VkFormat::VK_FORMAT_E5B9G9R9_UFLOAT_PACK32: return 4;

		case VkFormat::VK_FORMAT_D16_UNORM: return 2;

		case VkFormat::VK_FORMAT_X8_D24_UNORM_PACK32:
		case VkFormat::VK_FORMAT_D32_SFLOAT: return 4;

		case VkFormat::VK_FORMAT_S8_UINT: return 1;

		case VkFormat::VK_FORMAT_D16_UNORM_S8_UINT: return 3;

		case VkFormat::VK_FORMAT_D24_UNORM_S8_UINT: return 4;

		case VkFormat::VK_FORMAT_D32_SFLOAT_S8_UINT: return 5;
		...
		case VkFormat::VK_FORMAT_BC7_SRGB_BLOCK: return 16;
		...
		case VkFormat::VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK: return 8;

		case VkFormat::VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK:
		case VkFormat::VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK: return 16;

		case VkFormat::VK_FORMAT_EAC_R11_UNORM_BLOCK:
		case VkFormat::VK_FORMAT_EAC_R11_SNORM_BLOCK: return 8;
		...
		case VkFormat::VK_FORMAT_ASTC_12x12_SRGB_BLOCK: return 16;

		case VkFormat::VK_FORMAT_G8B8G8R8_422_UNORM: return 4;
